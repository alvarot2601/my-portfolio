...
function App() {
  ...
  return (
    <div className=''>
      ...
      <div ref={scrollbarWrapper} id="scrollbar-wrapper"  className='hidden lg:sticky lg:right-0 lg:bottom-0 lg:top-0 h-[30px] lg:h-full  w-full lg:w-[30px] bg-transparent lg:bg-slate-50 z-10'>
