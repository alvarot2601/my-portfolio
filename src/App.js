...
function App() {
  ...
  return (
    <div className=''>
      ...
      <div ref={scrollbarWrapper} id="scrollbar-wrapper" className='fixed right-0 bottom-0 md:top-0 h-[30px] md:h-full  sm:block md:block w-full md:w-[30px] bg-transparent md:bg-slate-50 z-10'>
