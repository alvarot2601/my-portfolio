        ...
        <div className="contact__subcontainer w-full">
          <div className="contact__action w-full">
            ...
            <div className="w-full flex gap-5 items-center justify-center sm:justify-start">
              <a href="https://www.linkedin.com/in/alvaro-taibo-developer/" target="_blank" aria-label="Link to my linkedin profile" rel="noreferrer">
                <AiFillLinkedin />
              </a>
              <a href="https://github.com/alvarot2601/" target="_blank" aria-label="Link to my github" rel="noreferrer">
                <AiFillGithub />
              </a>
            </div>
